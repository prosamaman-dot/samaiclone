...
Sam:"""
        ...
        return jsonify({
            "reply": f"Yo, I'm Samuel - 16, independent builder, trader, self-taught developer! 😄 You asked: '{user_message}'. Let's be real and solve this! What's the actual problem we need to tackle? 🔥",
            "error": str(e)
